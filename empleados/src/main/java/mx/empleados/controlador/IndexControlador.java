package mx.empleados.controlador;

import jakarta.servlet.http.HttpServletRequest;
import mx.empleados.modelo.Empleado;
import mx.empleados.servicio.EmpleadoServicio;
...
public class IndexControlador {
    ...
    @Autowired //para que spring lo inyecte
    EmpleadoServicio empleadoServicio;  // lo inyectamos para poder usarlo

    @RequestMapping(value = "/", method = RequestMethod.GET)
    public String iniciar(ModelMap modelo){ // el objeto modelo se comparte con la vista
